...
# Read more about Django model fields here: https://docs.djangoproject.com/en/3.1/ref/models/fields/
...
# Course model: Note the many-to-many relationship between course and instructors
class Course(models.Model):
    name = models.CharField(null=False, max_length=100, default='online course')
    description = models.CharField(max_length=500)
    # Many-To-Many relationship with Instructor
    instructors = models.ManyToManyField(Instructor)
    # Many-To-Many relationship with learners via Enrollment
