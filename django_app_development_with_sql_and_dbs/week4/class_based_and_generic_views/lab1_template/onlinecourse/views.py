...
#This is manual implementation using classes
...
# This is generic-class based implementation which reuses built-in functionality in Django to make it easier.
# You need less lines of code to implement the same functionality.
